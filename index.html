...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ✅ (Só funciona em temas/Jekyll no Pages; não afeta seu site normal) */
    ...
    /* ✅ ORIENTAÇÃO (corrigido para iPhone não “sumir” texto) */
    .rule{
      margin-top: 14px;
      padding: 14px;
      border-radius: 16px;
    ...
    .ruleTitle{
      ...
      font-size: 16px;
      line-height: 1.2;
      color:#1f3b66 !important;            /* ✅ força cor */
      -webkit-text-fill-color:#1f3b66;     /* ✅ iOS fix */
      position: relative;
      z-index: 2;
      margin: 0 0 12px 0;
    }
    ...
    .step{
      ...
      -webkit-text-fill-color:#2a3242; /* ✅ iOS fix */
    }
    .step b{ color:#2d2250 !important; -webkit-text-fill-color:#2d2250; }
